...
3. Consistent. Same offer names, prices, and positioning across every asset. index.html equals site/index.html. Title, meta description, and JSON-LD match the on-page copy. No leftover old framing: scan for "AI visibility", "get recommended", "who gets named", "not named", "invisible", "recommendation share", "Visibility Report", "Visibility Score".
